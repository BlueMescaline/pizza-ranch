...
--
-- Host: 127.0.0.1
-- Generation Time: May 29, 2015 at 12:32 PM
...
(6, 1, 'asd', 'a8f5f167f44f4964e6c998dee827110c', 'asdasdasdas', 'asdasd', 0, 'JVHUAXIVOOAFGLN');
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_hungarian_ci AUTO_INCREMENT=197 ;
...
CREATE TABLE IF NOT EXISTS `rendelesek` (
  ...
  `pizzak` varchar(50) COLLATE utf8_hungarian_ci NOT NULL,
  `darabszam` varchar(50) COLLATE utf8_hungarian_ci NOT NULL,
  `cim` varchar(100) COLLATE utf8_hungarian_ci NOT NULL,
  `ar` smallint(10) NOT NULL,
...
INSERT INTO `rendelesek` (`rend_ID`, `username`, `pizzak`, `darabszam`, `cim`, `ar`, `datum`) VALUES
(44, '123', '2,3', '2,1', 'Szabadka 24000, Jurij Gagarin 24, , ', 2830, '2014-09-01 10:55:21'),
(45, 'SelRobert', '1,2', '2,1', 'Szabadka 24000, Marka Oreskovica 16, , ', 2670, '2014-09-01 15:08:51');
...
(29, 0, 'robert', 'a8f5f167f44f4964e6c998dee827110c', 'asdasd', 'asdasd', 132156, 'asdasasd', 'OAMFVOULVMRKUFR');
