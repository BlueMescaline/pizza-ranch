...
?>
    <h2><a href="felhasznalok.php"> Vissza</a><br/>
        ...
        <a href="add_user.php?type=admin">Admin regisztrálása</a></h2>
<?php
if (isset($_GET['error']) and !empty($_GET['error'])) {
  switch ($_GET['error']){
   case 1: echo "<b>Sikeres regisztráció. E-mail elküldve a megadott címre.</b>";break;
   case 2: echo "<b>1 felhsználó sikeresen törölve.</b>";break;
   case 3: echo "<b>1 felhsználó sikeresen módosítva.</b>";break;
